...
const trampoline8 = rscTableCreateOwn.bind(null, handleTable9);
...
const trampoline10 = rscTableCreateOwn.bind(null, handleTable11);
...
const trampoline12 = rscTableCreateOwn.bind(null, handleTable10);
...
const trampoline14 = rscTableCreateOwn.bind(null, handleTable5);
const trampoline15 = rscTableCreateOwn.bind(null, handleTable4);
...
const trampoline23 = rscTableCreateOwn.bind(null, handleTable19);
...
const trampoline25 = rscTableCreateOwn.bind(null, handleTable20);
...
const trampoline28 = rscTableCreateOwn.bind(null, handleTable12);
...
const trampoline30 = rscTableCreateOwn.bind(null, handleTable21);
const trampoline31 = rscTableCreateOwn.bind(null, handleTable18);
const trampoline32 = rscTableCreateOwn.bind(null, handleTable13);
const trampoline33 = rscTableCreateOwn.bind(null, handleTable14);
const trampoline34 = rscTableCreateOwn.bind(null, handleTable15);
const trampoline35 = rscTableCreateOwn.bind(null, handleTable16);
const trampoline36 = rscTableCreateOwn.bind(null, handleTable6);
const trampoline37 = rscTableCreateOwn.bind(null, handleTable7);
const trampoline38 = rscTableCreateOwn.bind(null, handleTable8);
  ...
  let gen = (function* init () {
    ...
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      '[export]nomic-foundation:slang/bindings': {
        '[resource-drop]binding-graph': trampoline29,
        '[resource-drop]built-in-location': trampoline19,
        '[resource-drop]definition': trampoline16,
        '[resource-drop]reference': trampoline17,
        '[resource-drop]user-file-location': trampoline18,
        '[resource-new]binding-graph': trampoline28,
        '[resource-new]built-in-location': trampoline35,
        '[resource-new]definition': trampoline32,
        '[resource-new]reference': trampoline33,
        '[resource-new]user-file-location': trampoline34,
      },
      '[export]nomic-foundation:slang/compilation': {
        '[resource-drop]compilation-unit': trampoline26,
        '[resource-drop]file': trampoline27,
        '[resource-drop]internal-compilation-builder': trampoline24,
        '[resource-new]compilation-unit': trampoline25,
        '[resource-new]file': trampoline30,
        '[resource-new]internal-compilation-builder': trampoline23,
      },
      '[export]nomic-foundation:slang/cst': {
        '[resource-drop]ancestors-iterator': trampoline9,
        '[resource-drop]cursor': trampoline4,
        '[resource-drop]cursor-iterator': trampoline3,
        '[resource-drop]edge': trampoline1,
        '[resource-drop]nonterminal-node': trampoline2,
        '[resource-drop]query': trampoline13,
        '[resource-drop]query-match-iterator': trampoline11,
        '[resource-drop]terminal-node': trampoline5,
        '[resource-new]ancestors-iterator': trampoline8,
        '[resource-new]cursor': trampoline37,
        '[resource-new]cursor-iterator': trampoline38,
        '[resource-new]edge': trampoline36,
        '[resource-new]nonterminal-node': trampoline15,
        '[resource-new]query': trampoline12,
        '[resource-new]query-match-iterator': trampoline10,
        '[resource-new]terminal-node': trampoline14,
        '[resource-rep]edge': trampoline0,
        '[resource-rep]nonterminal-node': trampoline7,
        '[resource-rep]terminal-node': trampoline6,
      },
      '[export]nomic-foundation:slang/parser': {
        '[resource-drop]parse-output': trampoline22,
        '[resource-drop]parser': trampoline21,
        '[resource-new]parse-output': trampoline31,
        '[resource-new]parser': trampoline20,
      },
